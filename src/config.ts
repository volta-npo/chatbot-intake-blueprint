  ...
  "criteria": [
    {
      ...
      "guidance": "Implement and verify faq boundary map with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "escalation-rules",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify escalation rules with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify knowledge source checklist with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "safety-qa-script",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify safety qa script with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
