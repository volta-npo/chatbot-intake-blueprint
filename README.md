...
# ⚡ Chatbot Intake Blueprint

### A safe blueprint for building small-business chatbots that answer FAQs without pretending to be human experts.
...
**AI & Automation** · **Repo 31/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/31-chatbot-intake-blueprint/) · [Report an issue](https://github.com/volta-npo/31-chatbot-intake-blueprint/issues) · [Volta](https://voltanpo.org)
...
**Chatbot Intake Blueprint** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps AI automation students delivering simple assistants turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Chatbots are easy to overpromise and hard to scope responsibly for small organizations.

### The niche

Responsible AI assistants for local business websites.

### North-star metric

`bot answers covered by approved knowledge sources`
...
sequenceDiagram
    ...
    participant T as Chatbot Intake Blueprint
...
|---|---|
| **Domain workbench** | A purpose-built chatbot blueprint interface for a safe blueprint for building small-business chatbots that answer faqs without pretending to be human experts. |
...
|---:|---|---|
| 1 | **FAQ boundary map** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Escalation rules** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Knowledge source checklist** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Safety QA script** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
```bash
git clone https://github.com/volta-npo/31-chatbot-intake-blueprint.git
cd 31-chatbot-intake-blueprint
npm test
npm start
```
